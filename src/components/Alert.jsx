...
/**
 * Alert Component - Matches the design reference
 * 
...
const Alert = ({ 
    ...
    const defaultDescriptions = {
        ...
        error: "Error! Indicates an error that needs to be corrected."
    };

    const displayTitle = title || defaultTitles[type];
    const displayMessage = message || defaultDescriptions[type];
    ...
    return (
        <div className={`${colors.bg} ${colors.border} border rounded-lg p-4 ${className} relative`}>
