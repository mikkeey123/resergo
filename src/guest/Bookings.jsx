...
const Bookings = ({ onBack }) => {
    ...
    const cancelRequestedBookings = bookings.filter(booking => booking.status === "cancel_requested");
    ...
    return (
        <div className="bg-white min-h-screen py-8 px-4 sm:px-8 md:px-12 lg:px-16">
                        ...
                        {pendingBookings.map((booking) => (
                            ...
                            >
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-200">
                                    ...
                                    >
                                        <FaBan />
                                        <span>{processingId === booking.id ? "Processing..." : "Cancel Booking"}</span>
                                    </button>
                                </div>
                            </div>
                        ))}
            ...
            {cancelRequestedBookings.length > 0 && (
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-900 mb-6">Cancellation Requests</h2>
                    <div className="space-y-4">
                        {cancelRequestedBookings.map((booking) => (
                            ...
                            >
                                ...
                                <p className="text-sm text-orange-600 mt-3">Waiting for host approval...</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {canceledBookings.length > 0 && (
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-900 mb-6">Canceled Bookings</h2>
                    <div className="space-y-4">
